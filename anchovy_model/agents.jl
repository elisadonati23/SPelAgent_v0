@agent struct Anchovy(NoSpaceAgent)
    ...
    Dead::Bool                # Indicates if the anchovy is dead
    ...
    metamorph::Bool           # Indicates if the anchovy has metamorphosed -- In DEB meaning
    ...
    spawned::Float64          # Number of times the anchovy has spawned
end